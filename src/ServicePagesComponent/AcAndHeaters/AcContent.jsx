...
import TrustImage from "../../assets/images/images/AcContent.png";
import './AcContent.css';

const AcContent = () => {
    return (
        <div className="AcContent-containerss">
          {/* Text Section */}
          <div className="AcContent-textss">
...
Schedule an auto service and maintenance appointment with Autohouse of Switzerland Inc today or visit us at 3402 San Jacinto St, Houston, TX 77004.
            ...
            <Link to="/contact" className="AcContentbtnssd">Let's Get Started</Link>
          </div>
    
          {/* Image Section */}
          <div className="AcContent-imagess">
            <img src={TrustImage} alt="Trust and Quality" className="AcContentmainssd-img" />
