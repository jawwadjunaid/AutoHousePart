...
import "./AcAutoHouse.css"; // CSS file import
import AutoHouseIMG from '../../assets/images/images/AcAutoHouse.png';
...
const AcAutoHouse = () => {
 const [activeIndex, setActiveIndex] = useState(null);
  ...
  return (
    <div className="AcAutocontainer">
      <div className="AcAutocontent">
        {/* Text Section */}
        <div className="AcAutotext-section">
          <h2 style={{ fontSize: '2.81rem', color: '#0A0A0A' }}>
          Experience Expert Heater Services
          </h2>
          {/* <p className="AcAutosubtitle" style={{ fontSize: '1.25rem', color: '#0A0A0A' }}>
            For All Your Service and Maintenance Needs?
          </p> */}
          <p className="AcAutodescription" style={{ fontSize: '1rem', color: '#0A0A0A' }}>
...
Here’s why you should entrust your European vehicle to us:
          ...
          <div className="AcAutoaccordion">
            {[
              ...
              <div className="AcAutoaccordion-item" key={index} onClick={() => toggleAccordion(index)}>
                ...
                {activeIndex === index && (
                  <div className="AcAutoaccordion-content">
                    {item.content}
                  </div>
                )}
              </div>
        ...
        {/* Image Section */}
        <div className="AcAutoimage-section">
